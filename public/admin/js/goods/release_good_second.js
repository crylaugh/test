...
function PackageProductInfo() {
	...
	productViewObj.jifen = $("#jifendixian").val().replace(/^\s*/g, "").replace(/\s*$/g, "") == "" ? 0 : $("#jifendixian").val().replace(/^\s*/g, "").replace(/\s*$/g, "");// 积分抵现
	...
	productViewObj.brandId = $(".select_brand").attr("data-brand-id");//品牌id
