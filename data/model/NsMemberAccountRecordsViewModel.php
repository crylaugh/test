...
class NsMemberAccountRecordsViewModel extends BaseModel {
 ...
 /**
    ...
    public function getViewQuery($page_index, $page_size, $condition, $order)
    {
        ...
        ->field('nmar.id, nmar.uid, nmar.shop_id, nmar.account_type, nmar.sign, nmar.number, nmar.from_type, nmar.data_id, nmar.text, nmar.create_time, nmar.handle_obj, su.nick_name, su.user_name, su.user_tel, su.user_email, su.user_headimg');
