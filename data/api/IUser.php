...
{   
     ...
     */
    function add($user_name, $password, $email, $mobile, $tuijian, $real_name, $is_system, $qq_openid, $qq_info, $wx_openid, $wx_info, $wx_unionid, $is_member, $instance_id);
     ...
     */
    function updateUserInfo($uid, $user_name, $email, $sex, $status, $mobile, $nick_name, $tuijian, $real_name);
