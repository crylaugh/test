...
class Config extends BaseService implements IConfig
{
     ...
     */
    public function getCustomTemplateList($page_index, $page_size, $condition, $order, $field)
    {
     ...
     */
    public function getCustomTemplateById($id)
    {
        $custom_template_model = new CustomTemplateModel();
     ...
     */
    public function getDefaultCustomTemplate($shop_id)
    {
        $custom_template_model = new CustomTemplateModel();
        $res = $custom_template_model->getInfo([
            "shop_id" => $shop_id,
