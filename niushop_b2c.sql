...
-- Script date 2017-09-18 19:39:10
...
-- Table `ga_1.15_niushop_yanshi`.nc_cms_article does not contain any data (it is empty)

-- 
-- Dumping data for table nc_cms_article_class
--

-- Table `ga_1.15_niushop_yanshi`.nc_cms_article_class does not contain any data (it is empty)

-- 
-- Dumping data for table nc_cms_comment
--

-- Table `ga_1.15_niushop_yanshi`.nc_cms_comment does not contain any data (it is empty)

-- 
-- Dumping data for table nc_cms_topic
--

-- Table `ga_1.15_niushop_yanshi`.nc_cms_topic does not contain any data (it is empty)

-- 
-- Dumping data for table ns_account
--

-- Table `ga_1.15_niushop_yanshi`.ns_account does not contain any data (it is empty)

-- 
-- Dumping data for table ns_account_assistant_records
--

-- Table `ga_1.15_niushop_yanshi`.ns_account_assistant_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_account_order_records
--

-- Table `ga_1.15_niushop_yanshi`.ns_account_order_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_account_period
--

-- Table `ga_1.15_niushop_yanshi`.ns_account_period does not contain any data (it is empty)

-- 
-- Dumping data for table ns_account_records
--

-- Table `ga_1.15_niushop_yanshi`.ns_account_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_account_return_records
--

-- Table `ga_1.15_niushop_yanshi`.ns_account_return_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_account_withdraw_records
--

-- Table `ga_1.15_niushop_yanshi`.ns_account_withdraw_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_account_withdraw_user_records
--

-- Table `ga_1.15_niushop_yanshi`.ns_account_withdraw_user_records does not contain any data (it is empty)
...
-- Table `ga_1.15_niushop_yanshi`.ns_cart does not contain any data (it is empty)

-- 
-- Dumping data for table ns_click_fabulous
--

-- Table `ga_1.15_niushop_yanshi`.ns_click_fabulous does not contain any data (it is empty)

-- 
-- Dumping data for table ns_consult
--

-- Table `ga_1.15_niushop_yanshi`.ns_consult does not contain any data (it is empty)

-- 
-- Dumping data for table ns_consult_type
--

-- Table `ga_1.15_niushop_yanshi`.ns_consult_type does not contain any data (it is empty)

-- 
-- Dumping data for table ns_coupon
--

-- Table `ga_1.15_niushop_yanshi`.ns_coupon does not contain any data (it is empty)

-- 
-- Dumping data for table ns_coupon_goods
--

-- Table `ga_1.15_niushop_yanshi`.ns_coupon_goods does not contain any data (it is empty)

-- 
-- Dumping data for table ns_coupon_type
--

-- Table `ga_1.15_niushop_yanshi`.ns_coupon_type does not contain any data (it is empty)

-- 
-- Dumping data for table ns_express_company
--

-- Table `ga_1.15_niushop_yanshi`.ns_express_company does not contain any data (it is empty)

-- 
-- Dumping data for table ns_express_shipping
--

-- Table `ga_1.15_niushop_yanshi`.ns_express_shipping does not contain any data (it is empty)

-- 
-- Dumping data for table ns_express_shipping_items
--

-- Table `ga_1.15_niushop_yanshi`.ns_express_shipping_items does not contain any data (it is empty)
...
-- Table `ga_1.15_niushop_yanshi`.ns_gift_grant_records does not contain any data (it is empty)
...
-- Table `ga_1.15_niushop_yanshi`.ns_goods_attribute_deleted does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_attribute_value
--

-- Table `ga_1.15_niushop_yanshi`.ns_goods_attribute_value does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_brand
--

-- Table `ga_1.15_niushop_yanshi`.ns_goods_brand does not contain any data (it is empty)
...
(3, 0, '家用电器', 1, '家用电器', '#FFFFFF', 1, 0, 0, 0, '', 0, 0, ''),
(4, 0, '手机/运营商/数码', 2, '手机/运营商/数码', '#FFFFFF', 1, 0, 0, 0, '', 0, 0, ''),
(5, 0, '电脑/办公', 3, '电脑/办公', '#FFFFFF', 1, 0, 0, 0, '', 0, 0, ''),
(6, 0, '家居/家具/家装/厨具', 4, '家居/家具/家装/厨具', '#FFFFFF', 1, 0, 0, 0, '', 0, 0, ''),
(7, 0, '男装/女装/童装/内衣', 5, '男装/女装/童装/内衣', '#FFFFFF', 1, 0, 0, 0, '', 0, 0, ''),
(8, 0, '美妆个护/宠物', 6, '美妆个护/宠物', '#FFFFFF', 1, 0, 0, 0, '', 0, 0, ''),
(9, 0, '女鞋/箱包/钟表/珠宝', 7, '女鞋/箱包/钟表/珠宝', '#FFFFFF', 1, 0, 0, 0, '', 0, 0, ''),
(10, 0, '男鞋/运动/户外', 8, '男鞋/运动/户外', '#FFFFFF', 1, 0, 0, 0, '', 0, 0, ''),
(11, 0, '汽车/汽车用品', 9, '汽车/汽车用品', '#FFFFFF', 1, 0, 0, 0, '', 0, 0, ''),
(12, 0, '母婴/玩具用品', 10, '母婴/玩具用品', '#FFFFFF', 1, 0, 0, 0, '', 0, 0, ''),
(13, 0, '食品/酒类/生鲜/特产', 11, '食品/酒类/生鲜/特产', '#FFFFFF', 1, 0, 0, 0, '', 0, 0, ''),
(14, 0, '礼品鲜花/农资绿植', 12, '礼品鲜花/农资绿植', '#FFFFFF', 1, 0, 0, 0, '', 0, 0, ''),
(15, 0, '机票/酒店/旅游/生活', 13, '机票/酒店/旅游/生活', '#FFFFFF', 1, 0, 0, 0, '', 0, 0, '');

-- 
-- Dumping data for table ns_goods_comment
--

-- Table `ga_1.15_niushop_yanshi`.ns_goods_comment does not contain any data (it is empty)
...
-- Table `ga_1.15_niushop_yanshi`.ns_goods_evaluate does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_group
--

-- Table `ga_1.15_niushop_yanshi`.ns_goods_group does not contain any data (it is empty)
...
-- Table `ga_1.15_niushop_yanshi`.ns_goods_sku_picture does not contain any data (it is empty)

-- 
-- Dumping data for table ns_goods_sku_picture_delete
--

-- Table `ga_1.15_niushop_yanshi`.ns_goods_sku_picture_delete does not contain any data (it is empty)
...
-- Table `ga_1.15_niushop_yanshi`.ns_member_account does not contain any data (it is empty)

-- 
-- Dumping data for table ns_member_account_records
--

-- Table `ga_1.15_niushop_yanshi`.ns_member_account_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_member_balance_withdraw
--

-- Table `ga_1.15_niushop_yanshi`.ns_member_balance_withdraw does not contain any data (it is empty)

-- 
-- Dumping data for table ns_member_bank_account
--

-- Table `ga_1.15_niushop_yanshi`.ns_member_bank_account does not contain any data (it is empty)

-- 
-- Dumping data for table ns_member_express_address
--

-- Table `ga_1.15_niushop_yanshi`.ns_member_express_address does not contain any data (it is empty)

-- 
-- Dumping data for table ns_member_favorites
--

-- Table `ga_1.15_niushop_yanshi`.ns_member_favorites does not contain any data (it is empty)

-- 
-- Dumping data for table ns_member_gift
--

-- Table `ga_1.15_niushop_yanshi`.ns_member_gift does not contain any data (it is empty)
...
-- Table `ga_1.15_niushop_yanshi`.ns_member_recharge does not contain any data (it is empty)

-- 
-- Dumping data for table ns_offpay_area
--

-- Table `ga_1.15_niushop_yanshi`.ns_offpay_area does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order
--

-- Table `ga_1.15_niushop_yanshi`.ns_order does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_action
--

-- Table `ga_1.15_niushop_yanshi`.ns_order_action does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_goods
--

-- Table `ga_1.15_niushop_yanshi`.ns_order_goods does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_goods_express
--

-- Table `ga_1.15_niushop_yanshi`.ns_order_goods_express does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_goods_promotion_details
--

-- Table `ga_1.15_niushop_yanshi`.ns_order_goods_promotion_details does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_payment
--

-- Table `ga_1.15_niushop_yanshi`.ns_order_payment does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_pickup
--

-- Table `ga_1.15_niushop_yanshi`.ns_order_pickup does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_promotion_details
--

-- Table `ga_1.15_niushop_yanshi`.ns_order_promotion_details does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_refund
--

-- Table `ga_1.15_niushop_yanshi`.ns_order_refund does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_shipping_fee
--

-- Table `ga_1.15_niushop_yanshi`.ns_order_shipping_fee does not contain any data (it is empty)

-- 
-- Dumping data for table ns_order_shop_return
--

-- Table `ga_1.15_niushop_yanshi`.ns_order_shop_return does not contain any data (it is empty)

-- 
-- Dumping data for table ns_pickup_point
--

-- Table `ga_1.15_niushop_yanshi`.ns_pickup_point does not contain any data (it is empty)
...
-- Table `ga_1.15_niushop_yanshi`.ns_platform_goods_recommend does not contain any data (it is empty)

-- 
-- Dumping data for table ns_platform_goods_recommend_class
--

-- Table `ga_1.15_niushop_yanshi`.ns_platform_goods_recommend_class does not contain any data (it is empty)
...
-- Table `ga_1.15_niushop_yanshi`.ns_platform_link does not contain any data (it is empty)

-- 
-- Dumping data for table ns_point_config
--

-- Table `ga_1.15_niushop_yanshi`.ns_point_config does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_bundling
--

-- Table `ga_1.15_niushop_yanshi`.ns_promotion_bundling does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_bundling_goods
--

-- Table `ga_1.15_niushop_yanshi`.ns_promotion_bundling_goods does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_discount
--

-- Table `ga_1.15_niushop_yanshi`.ns_promotion_discount does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_discount_goods
--

-- Table `ga_1.15_niushop_yanshi`.ns_promotion_discount_goods does not contain any data (it is empty)
...
-- Table `ga_1.15_niushop_yanshi`.ns_promotion_gift does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_gift_goods
--

-- Table `ga_1.15_niushop_yanshi`.ns_promotion_gift_goods does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_mansong
--

-- Table `ga_1.15_niushop_yanshi`.ns_promotion_mansong does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_mansong_goods
--

-- Table `ga_1.15_niushop_yanshi`.ns_promotion_mansong_goods does not contain any data (it is empty)

-- 
-- Dumping data for table ns_promotion_mansong_rule
--

-- Table `ga_1.15_niushop_yanshi`.ns_promotion_mansong_rule does not contain any data (it is empty)
...
-- Table `ga_1.15_niushop_yanshi`.ns_shop does not contain any data (it is empty)

-- 
-- Dumping data for table ns_shop_ad
--

-- Table `ga_1.15_niushop_yanshi`.ns_shop_ad does not contain any data (it is empty)

-- 
-- Dumping data for table ns_shop_coin_records
--

-- Table `ga_1.15_niushop_yanshi`.ns_shop_coin_records does not contain any data (it is empty)

-- 
-- Dumping data for table ns_shop_express_address
--

-- Table `ga_1.15_niushop_yanshi`.ns_shop_express_address does not contain any data (it is empty)

-- 
-- Dumping data for table ns_shop_group
--

-- Table `ga_1.15_niushop_yanshi`.ns_shop_group does not contain any data (it is empty)

-- 
-- Dumping data for table ns_shop_navigation
--

-- Table `ga_1.15_niushop_yanshi`.ns_shop_navigation does not contain any data (it is empty)
...
-- Table `ga_1.15_niushop_yanshi`.ns_shop_order_account_records does not contain any data (it is empty)
...
-- Table `ga_1.15_niushop_yanshi`.ns_supplier does not contain any data (it is empty)

-- 
-- Dumping data for table sys_addons
--

-- Table `ga_1.15_niushop_yanshi`.sys_addons does not contain any data (it is empty)
...
-- Table `ga_1.15_niushop_yanshi`.sys_custom_template does not contain any data (it is empty)
...
-- Table `ga_1.15_niushop_yanshi`.sys_instance_type does not contain any data (it is empty)
...
(487, '模板编辑', 'admin', 'express', 'expresstemplate', 529, 3, 'express/expresstemplate', 0, 1, 0, '', '', '', 1, 1496459993, NULL),
...
(521, '添加自提点', 'admin', 'shop', 'addpickuppoint', 529, 3, 'shop/addpickuppoint', 0, 1, 0, '', '', '', 1, 1498135759, 1498135759),
(522, '修改自提点', 'admin', 'shop', 'updatepickuppoint', 529, 3, 'shop/updatepickuppoint', 0, 1, 0, '', '', '', 1, 1498135759, 1498135759),
...
-- Table `ga_1.15_niushop_yanshi`.sys_notice_template does not contain any data (it is empty)
...
-- Table `ga_1.15_niushop_yanshi`.sys_user_log does not contain any data (it is empty)

-- 
-- Dumping data for table sys_version_devolution
--

-- Table `ga_1.15_niushop_yanshi`.sys_version_devolution does not contain any data (it is empty)

-- 
-- Dumping data for table sys_version_patch
--

-- Table `ga_1.15_niushop_yanshi`.sys_version_patch does not contain any data (it is empty)
...
-- Table `ga_1.15_niushop_yanshi`.sys_weixin_auth does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_default_replay
--

-- Table `ga_1.15_niushop_yanshi`.sys_weixin_default_replay does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_fans
--

-- Table `ga_1.15_niushop_yanshi`.sys_weixin_fans does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_follow_replay
--

-- Table `ga_1.15_niushop_yanshi`.sys_weixin_follow_replay does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_functions_button
--

-- Table `ga_1.15_niushop_yanshi`.sys_weixin_functions_button does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_instance_msg
--

-- Table `ga_1.15_niushop_yanshi`.sys_weixin_instance_msg does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_key_replay
--

-- Table `ga_1.15_niushop_yanshi`.sys_weixin_key_replay does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_media
--

-- Table `ga_1.15_niushop_yanshi`.sys_weixin_media does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_media_item
--

-- Table `ga_1.15_niushop_yanshi`.sys_weixin_media_item does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_menu
--

-- Table `ga_1.15_niushop_yanshi`.sys_weixin_menu does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_msg_template
--

-- Table `ga_1.15_niushop_yanshi`.sys_weixin_msg_template does not contain any data (it is empty)
...
-- Table `ga_1.15_niushop_yanshi`.sys_weixin_user_msg does not contain any data (it is empty)

-- 
-- Dumping data for table sys_weixin_user_msg_replay
--

-- Table `ga_1.15_niushop_yanshi`.sys_weixin_user_msg_replay does not contain any data (it is empty)

-- 
-- Dumping data for table sys_wexin_onekeysubscribe
--

-- Table `ga_1.15_niushop_yanshi`.sys_wexin_onekeysubscribe does not contain any data (it is empty)
