...
class Index extends BaseController
{
    ...
    {   
        ...
        //mymy总金额
        $data['all_money'] = $order->getPayMoneySum($tmp_condition); 
        $data['all_jifen'] = $order->getJihuoNumSum($tmp_condition); 
        $data['all_money'] = $data['all_money'] - $data['all_jifen'] * ($res[promotion_price]-$res[jifen]);
        // 查询今天
        ...
        $data['curr_day_money'] = $order->getPayMoneySum($tmp_condition); 
        $data['curr_jifen_money'] = $order->getJihuoNumSum($tmp_condition); 
        $data['curr_day_money'] = $data['curr_day_money'] - $data['curr_jifen_money'] * ($res[promotion_price]-$res[jifen]);
        // 查询今天的订单总金额
        $tmp_condition = $condition;
        ...
        $data['yesterday_jifen'] = $order->getJihuoNumSum($tmp_condition); 
        $data['yesterday_money'] = $data['yesterday_money'] - $data['yesterday_jifen'] * ($res[promotion_price]-$res[jifen]);
        $data['yesterday_goods'] = $order->getGoodsNumSum($tmp_condition);
        $data['yesterday_goods'] = $data['yesterday_goods'] - $data['yesterday_jifen'];
        // 查看本月
        $tmp_condition = $condition;
        ...
        $data['month_jifen'] = $order->getJihuoNumSum($tmp_condition); 
        $data['month_money'] = $data['month_money'] - $data['month_jifen'] * ($res[promotion_price]-$res[jifen]);
        $data['month_goods'] = $order->getGoodsNumSum($tmp_condition);
        $data['month_goods'] = $data['month_goods'] - $data['month_jifen'];
        return $data;
    }
