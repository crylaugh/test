...
class Config extends BaseController
{
    ...
    public function updateConstant()
    {
        ...
        if (request()->isAjax()) {
            ...
            $retval = $constant->updateConstant($id, $value);
            return AjaxReturn($retval);
        } else {
            $res = $constant->getConstantInfo();
            $this->assign('res', $res);
            return view($this->style . "Config/constant");
        }
    }
    ...
    public function userNotice()
    {
        $web_config = new WebConfig();
        if (request()->isAjax()) {
            $user_notice = request()->post('user_notice','');
