<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:43:"template/adminblue\Config\notifyConfig.html";i:1501559758;s:28:"template/adminblue\base.html";i:1508840920;s:45:"template/adminblue\controlCommonVariable.html";i:1503719297;s:32:"template/adminblue\urlModel.html";i:1504865854;s:34:"template/adminblue\pageCommon.html";i:1505550036;s:34:"template/adminblue\openDialog.html";i:1500263975;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
	...
	<tbody>
		<?php if(is_array($notify_list) || $notify_list instanceof \think\Collection || $notify_list instanceof \think\Paginator): $i = 0; $__LIST__ = $notify_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$notify_obj): $mod = ($i % 2 );++$i;?>
			<tr style="border:1px solid #e5e5e5;border-top:0;background:none;">
				...
				<td style="text-align: center;background:none;" class="is_use_<?php echo $notify_obj['id']; ?>"><i class="fa fa-check text-success text-active"></i></td>
				<?php else: ?>
