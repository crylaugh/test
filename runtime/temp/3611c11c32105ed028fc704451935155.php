<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:38:"template/adminblue\Config\shopSet.html";i:1501916568;s:28:"template/adminblue\base.html";i:1508840920;s:45:"template/adminblue\controlCommonVariable.html";i:1503719297;s:32:"template/adminblue\urlModel.html";i:1504865854;s:34:"template/adminblue\pageCommon.html";i:1505550036;s:34:"template/adminblue\openDialog.html";i:1509005619;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	<dl>
		<dt>自动收货时间:</dt>
		<dd>
			<input id="order_auto_delinery" type="number" min="0.00" step="1.00" onkeyup="value=value.replace(/[^\d+(\.\d+)?]/g,'')" value="<?php echo $shopSet['order_auto_delinery']; ?>" class="input-common" /> 
	...
	<dl>
		<dt>订单自动关闭时间:</dt>
		<dd>
			<input id="order_buy_close_time" type="number" min="0.00" step="1.00" onkeyup="value=value.replace(/[^\d+(\.\d+)?]/g,'')" value="<?php echo $shopSet['order_buy_close_time']; ?>" class="input-common" /> 
	...
	<dl>
		...
		<dd>
			<div class="controls">
				<label class="label-radio"><input type="radio" name="order_delivery_pay" value="1"  id="payResultYes" <?php if($shopSet['order_delivery_pay'] == 1): ?>checked="checked"<?php endif; ?>>启用</label> 
				<label class="label-radio"><input type="radio" name="order_delivery_pay" value="0"  id="payResultNo"  <?php if($shopSet['order_delivery_pay'] == 0): ?>checked="checked"<?php endif; ?>>禁用</label>
			</div>
	...
	<dl>
		...
		<dd>
			...
			<input type="hidden" id="closeday" value="<?php echo getTimeStampTurnTime($shopSet['order_delivery_complete_time'] ); ?>">
	...
	<dl>
		...
		<dd>
			<div class="controls">
				...
				<input type="hidden" id="is_logistics" value="<?php echo $shopSet['is_logistics']; ?>">
			</div>
	...
	<dl>
		<dt>发票税率:</dt>
		<dd>
			<input id="order_invoice_tax" type="number" min="0.00" step="0.01" value="<?php echo $shopSet['order_invoice_tax']; ?>" class="select-common" />
	...
	<dl>
		<dt>发票内容:</dt>
		<dd>
			<textarea  rows="2" id="order_invoice_content" class="textarea input-common" maxlength="50"><?php echo $shopSet['order_invoice_content']; ?></textarea>
