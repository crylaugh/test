<?php if (!defined('THINK_PATH')) exit(); /*a:19:{s:39:"template/shop\blue\Goods\goodsInfo.html";i:1505285307;s:28:"template/shop\blue\base.html";i:1505297202;s:32:"template/shop\blue\urlModel.html";i:1505377008;s:34:"template/shop\blue\controlTop.html";i:1504180836;s:41:"template/shop\blue\controlHeadSerach.html";i:1504508481;s:44:"template/shop\blue\controlHeadSearchAdv.html";i:1503280183;s:43:"template/shop\blue\controlHeadGoodType.html";i:1502679157;s:40:"template/shop\blue\controlCommonNav.html";i:1502706001;s:43:"template/shop\blue\controlRightSidebar.html";i:1503280183;s:44:"template/shop\blue\Goods\controlGallery.html";i:1504095914;s:46:"template/shop\blue\Goods\controlStoreRank.html";i:1503280183;s:49:"template/shop\blue\Goods\controlGoodEvaluate.html";i:1503280183;s:45:"template/shop\blue\controlCommonPageAjax.html";i:1502679157;s:55:"template/shop\blue\Goods\controlPurchaseConsulting.html";i:1502679157;s:50:"template/shop\blue\Goods\controlGoodsInfoData.html";i:1505458552;s:45:"template/shop\blue\controlBottomLinkHelp.html";i:1503280183;s:37:"template/shop\blue\controlBottom.html";i:1501752182;s:36:"template/shop\blue\controlLogin.html";i:1505297202;s:37:"template/shop\blue\baidu_js_push.html";i:1499844478;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	...
	<div class="spec-items">
		...
		<?php if(!(empty($goods_info['sku_picture_list']) || (($goods_info['sku_picture_list'] instanceof \think\Collection || $goods_info['sku_picture_list'] instanceof \think\Paginator ) && $goods_info['sku_picture_list']->isEmpty()))): ?>
			...
			<?php if(is_array($goods_info['sku_picture_list']) || $goods_info['sku_picture_list'] instanceof \think\Collection || $goods_info['sku_picture_list'] instanceof \think\Paginator): if( count($goods_info['sku_picture_list'])==0 ) : echo "" ;else: foreach($goods_info['sku_picture_list'] as $key=>$img): if(is_array($img['album_picture_list']) || $img['album_picture_list'] instanceof \think\Collection || $img['album_picture_list'] instanceof \think\Paginator): if( count($img['album_picture_list'])==0 ) : echo "" ;else: foreach($img['album_picture_list'] as $k=>$p): if($k==0): ?>
					...
					<?php endif; ?>
							<img src="<?php echo __IMG($p['pic_cover_micro']); ?>" data_big_img="<?php echo __IMG($p['pic_cover_big']); ?>"/>
						</li>
		...
		<!-- 否则显示商品组图 -->
			<?php if(is_array($goods_info['img_list']) || $goods_info['img_list'] instanceof \think\Collection || $goods_info['img_list'] instanceof \think\Paginator): if( count($goods_info['img_list'])==0 ) : echo "" ;else: foreach($goods_info['img_list'] as $k=>$img): if($k==0): ?>
				...
				<li>
				<?php endif; ?>
				<img src="<?php echo __IMG($img['pic_cover_micro']); ?>" data_big_img="<?php echo __IMG($img['pic_cover_big']); ?>"/>
				</li>
				...
				<div class="goods-price">
					...
					<div class="prom-gift" >
						...
						<div class="dd">
							<span class="prom-gift-label">
								<em><?php echo $goods_info['max_buy']; ?><?php echo lang('goods_individual'); ?></em>
							</span>
							<div></div>
						</div>
					</div>
					<?php endif; if($goods_info['min_buy']!=0): ?>
							...
							<div class="prom-gift" >
								...
								<div class="dd">
									<span class="prom-gift-label">
								<em><?php echo $goods_info['min_buy']; ?><?php echo lang('goods_individual'); ?></em>
								</span>
								<div></div>
								</div>
							</div>
					...
					<div class="dd">
						<div class="post-age">
							...
							<?php if(!empty($shipping_name)): if(empty($shipping_name[0]['company_name'])): ?>
							   ...
							   <?php echo lang('goods_no_goods'); endif; ?>
							</div>
<!-- 							<div class="post-age-info"> -->
				...
				<div class="choose js-skulist">
									...
									<li class="goods-spec-item <?php if($key==0): ?> selected<?php endif; ?>">
										<?php switch($spec_value['spec_show_type']): case "1": ?>
												...
												<a href="javascript:;" title="<?php echo $spec_value['spec_value_name']; ?>">
													...
													<span class="value-label" name="Span<?php echo $key; ?>" id="<?php echo $spec['spec_id']; ?>:<?php echo $spec_value['spec_value_id']; ?>"><?php echo $spec_value['spec_value_name']; ?></span>
													<?php else: ?>
													<img src="<?php echo __IMG($spec_value['spec_value_data']); ?>" style="width:30px;height:30px;">
													<span class="value-label" name="Span<?php echo $key; ?>" id="<?php echo $spec['spec_id']; ?>:<?php echo $spec_value['spec_value_id']; ?>" data-show-big-pic="<?php echo __IMG($spec_value['spec_value_data_big_src']); ?>"><?php echo $spec_value['spec_value_name']; ?></span>
													<?php endif; if($key==0): ?>
													<i></i><!-- 第一个选中 -->
													<?php endif; ?>
												</a>
					...
					<div class="action">
						<?php if($goods_info['state']==1): ?>
							...
							<div class="btn-buy"><a href="javascript:void(0);" class="add-cart bg-color" data-tag="to_cart"><i></i><?php echo lang('goods_add_cart'); ?></a></div>
						<?php else: ?>
							<div class="btn-buy"><a href="javascript:void(0);" class="no-auth "><?php echo lang('goods_laid_off'); ?>  </a></div>
				...
				<div id="main-nav-holder" class="goods-detail">
					...
					<div class="right-side">
						<a href="javascript:void(0);" class="right-addcart js-buy-now" data-tag="buy_now">
							<i></i>
							<?php if($integral_flag==1): ?>
							<span><?php echo lang('goods_exchange'); ?></span>
							<?php else: ?>
							<span><?php echo lang('goods_buy_now'); ?></span>
							<?php endif; ?>
						</a>
	...
	$.ajax({
		...
		success:function(data){
			...
			if(data['data'].length==0){
				$('#comment_content .tablelist').html('<div class="tip-box"><i class="tip-icon"></i><div class="tip-text"><?php echo lang('no_comment_yet'); ?></div></div>');
				$('#pagination').hide();
				return false;
			}
			for(var i=0;i<data['data'].length;i++){
				...
				member_name=dataitem['is_anonymous']==1?member_name.replace(member_name.substring(1,member_name.length),'***')+'(<?php echo lang('goods_shopkeeper_replies'); ?>)':member_name;
...
// 	})
	...
	function getExpressFee(province,city){
		...
		$.ajax({
			...
			success : function(res){
				if(res == "<?php echo lang('goods_no_goods'); ?>"){
					$(".js-buy-now").addClass("disabled");
					$(".add-cart").addClass("disabled");
				}else{
					$(".js-buy-now").removeClass("disabled");
				...
				$(".freight-info").text("<?php echo lang('goods_freight'); ?>："+res);
			}
		})
	}
});
