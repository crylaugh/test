<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:36:"template/adminblue\Wchat\qrcode.html";i:1503280183;s:28:"template/adminblue\base.html";i:1508840920;s:45:"template/adminblue\controlCommonVariable.html";i:1503719297;s:32:"template/adminblue\urlModel.html";i:1504865854;s:34:"template/adminblue\pageCommon.html";i:1505550036;s:34:"template/adminblue\openDialog.html";i:1500263975;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="table">
	...
	<div class="l qrcode" id="divBlock">
		...
		<img id="imgLogo" src="<?php echo __IMG($info['background']); ?>">
		<?php else: ?>
		<img id="imgLogo">
		<?php endif; ?>
		...
		<img id="logo" src="<?php echo __IMG($web_info['logo']); ?>" style="left:<?php echo $info['logo_left']; ?>;top:<?php echo $info['logo_top']; ?>;<?php if($info["is_logo_show"] == '0'): ?>display:none;<?php endif; ?>" ondragstart="return false">
		<img id="code" src="__STATIC__/images/template_qrcode.png" style="left:<?php echo $info['code_left']; ?>;top:<?php echo $info['code_top']; ?>;" ondragstart="return false">
	...
	<div class="r form">
		...
		<div class="set-style">
			...
			<dl>
				<dt>昵称文本颜色:</dt>
				<dd>
					<p><input id="nick_font_color" type="color" value="<?php echo $info['nick_font_color']; ?>" class="input-common"></p>
			...
			<dl>
				<dt>昵称字体大小:</dt>
				<dd>
					<p><input id="nick_font_size" type="number" min="10" max="36" step="1" size="4" value="<?php echo $info['nick_font_size']; ?>" class="input-common">像素</p>
			...
			<dl>
				<dt>是否显示logo:</dt>
				<dd>
					<p><input id="is_logo_show" type="checkbox" class="checkbox" <?php if($info['is_logo_show'] == '1'): ?>checked <?php endif; ?>/></p>
				</dd>
			</dl>
			<dl>
				<dt></dt>
