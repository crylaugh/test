...
<div class="set-style">
	...
	<dl>
		<dt>关键字:</dt>
		<dd>
			<p><input id="keywords" type="text" value="<?php echo $data['keywords']; ?>" placeholder="请输入关键字" class="input-common"/></p>
	...
	<dl>
		<dt>排序:</dt>
		<dd>
			<p><input id="sort" type="text"value="<?php echo $data['sort']; ?>" placeholder="请输入序号" class="input-common"></p>
		</dd>
	</dl>
	<dl>
		<dt>图片:</dt>
		<dd>
			<div class="class-logo">
				<p>
					...
					<img id="imglogo" src="<?php echo __IMG($data['category_pic']); ?>" >
					<?php else: ?>
					<img id="imglogo">
					<?php endif; ?>
				</p>
	...
	<dl>
		<dt>描述:</dt>
		<dd>
			<p><textarea id="description" placeholder="请输入描述" class="input-common"><?php echo $data['description']; ?></textarea></p>
		</dd>
	</dl>
	<dl>
		<dt></dt>
