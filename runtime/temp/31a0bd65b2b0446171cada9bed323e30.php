<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:46:"template/wap\default\\Member\balanceWater.html";i:1509675241;s:30:"template/wap\default\base.html";i:1507430043;s:34:"template/wap\default\urlModel.html";i:1505377008;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<section class="head">
	<a class="head_back" id="head_back" href="<?php echo __URL('APP_MAIN/member/index'); ?>"><i class="icon-back"></i></a>
	<div class="head-title"><?php echo lang('member_my_balance'); ?> </div>
</section>
...
<div id="main" class="detail-main">
	<div class="my-account">
		...
		<div class="account-box">
			...
			<p style="font-size: 14px;color: #ffc9b6;padding-bottom: 15px;"><?php echo lang('member_balance'); ?></p>
			<!-- <a href="<?php echo __URL('APP_MAIN/member/recharge'); ?>" class="account-title bottom"><?php echo lang('recharge'); ?></a> -->
		...
		<?php endif; ?> -->
			...
			<ul>
				<?php if($info[agent]): ?>
				<a href="<?php echo __URL('APP_MAIN/member/recharge'); ?>"><li class="account-option-left">开户积分充值</li></a>
				<?php else: ?>
				<a href="javascript:;" onclick="tanchuang()"><li class="account-option-left">开户积分充值</li></a>
				<?php endif; if($info[jihuo]): ?>
				<a href="<?php echo __URL('APP_MAIN/member/agent?shop_id='.$shopid); ?>"><li class="account-option-right">代理升级</li></a>
				<?php else: ?>
	...
	<table class="ns-table">
		...
		<tr align="center">
			...
			<td style="padding-top: 0.2rem; font-size: 14px; color: #888;">
				<span class="ns-lf"><?php echo $vo['text']; ?></span> <span class="ns-rg-time"><?php echo getTimeStampTurnTime($vo['create_time'] ); ?></span>
			</td>
		</tr>
	...
	<div>
		<div class="emptyFrame">
			<i class="user_money"></i><span><?php echo lang('you_don_not_have_a_balance_record_yet'); ?>！</span>
		</div>
	</div>
	<?php endif; ?>
</div>
