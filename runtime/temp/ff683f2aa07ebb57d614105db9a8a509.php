<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:38:"template/adminblue\Member\teamSon.html";i:1508832292;s:28:"template/adminblue\base.html";i:1508840920;s:45:"template/adminblue\controlCommonVariable.html";i:1503719297;s:32:"template/adminblue\urlModel.html";i:1504865854;s:34:"template/adminblue\pageCommon.html";i:1505550036;s:34:"template/adminblue\openDialog.html";i:1509005619;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<span style="font-size: 20px;line-height: 30px;margin-left: 20px;">昵称：<?php if($info['real_name']): ?><?php echo $info['real_name']; else: ?><?php echo $info['user_name']; endif; ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;手机号：<?php echo $info['user_tel']; ?></span>
<table class="table-class" style="width: 1100%;">
	<thead>
		<tr align="center">
			<th width="15%">子会员</th>
			<th width="20%">子会员</th>
	...
	<tbody>
		<?php foreach($son1 as $vo): ?> 
		<tr align="center">
			<td><?php if($vo['real_name']): ?><?php echo $vo['real_name']; else: ?><?php echo $vo['user_name']; endif; ?></td>
			<td><?php echo $vo['user_tel']; ?></td>
			<td>第一代</td>
			<td><?php echo $vo['level']['max_ji']; ?>/<?php echo $vo['level']['reduce_ji']; ?>/<?php echo $vo['level']['present_ji']; ?></td>
		</tr>
		<?php endforeach; ?>
		</tbody>
</table>
<table class="table-class" ><thead><tr align="center">
			<th width="15%"></th>
			<th width="20%"></th>
			<th width="20%"></th>
			<th width="20%"></th>
