<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:46:"template/adminblue\Member\memberLevelList.html";i:1508497751;s:28:"template/adminblue\base.html";i:1508840920;s:45:"template/adminblue\controlCommonVariable.html";i:1503719297;s:32:"template/adminblue\urlModel.html";i:1504865854;s:34:"template/adminblue\pageCommon.html";i:1505550036;s:34:"template/adminblue\openDialog.html";i:1509005619;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<li><a href="<?php echo __URL('ADMIN_MAIN/member/addmemberlevel'); ?>"><i class="fa fa-plus-circle"></i>&nbsp;添加等级</a></li>
			...
			if (data["data"].length > 0) {
				for (var i = 0; i < data["data"].length; i++) {
					...
					if(data['data'][i]['upgrade']==1){
						html += '<td>直推会员' + data['data'][i]['min_integral'] +'人</td>';
					}else if(data['data'][i]['upgrade']==2){
						html += '<td>团队会员' + data['data'][i]['quota'] +'人</td>';
					}else if(data['data'][i]['upgrade']==3 && data['data'][i]['relation']==1){
						html += '<td>直推会员' + data['data'][i]['min_integral'] +'人&nbsp;或&nbsp;团队会员' + data['data'][i]['quota'] +'人</td>';
					}else if(data['data'][i]['upgrade']==3 && data['data'][i]['relation']==2){
						html += '<td>直推会员' + data['data'][i]['min_integral'] +'人&nbsp;且&nbsp;团队会员' + data['data'][i]['quota'] +'人</td>';
