<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:48:"template/adminblue\Config\notifySmsTemplate.html";i:1504604293;s:28:"template/adminblue\base.html";i:1505297354;s:45:"template/adminblue\controlCommonVariable.html";i:1503719297;s:32:"template/adminblue\urlModel.html";i:1504865854;s:34:"template/adminblue\pageCommon.html";i:1505550036;s:34:"template/adminblue\openDialog.html";i:1500263975;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="template-message"><h1></h1><p style="width:90%;margin-left: 7px;">短信通知模板</p></div>
	<div class="tab-pane active">
		<div class="left_main">
			<ul>
				<?php if(is_array($template_type_list) || $template_type_list instanceof \think\Collection || $template_type_list instanceof \think\Paginator): if( count($template_type_list)==0 ) : echo "" ;else: foreach($template_type_list as $key=>$template_item): ?>
					<a href="javascript:void(0);" onclick="template_onclick(this);" id="<?php echo $template_item['template_code']; ?>">
		...
		<div class="right_main">
			...
			<div class="qianming"><div style="width:75px;float:left;">模板ID：</div><input type="text" id="template_titleid" value="<?php echo $template_select['template_title']; ?>" style="margin-right: 15px !important;" class="input-common" /><span style="font-size:13px;">必须与阿里大鱼的模板ID一致，否则无效!</span></div>
			<div class="qianming"><div style="width:75px;float:left;">短信签名：</div><input type="text" id="signNameid" style="margin-right: 15px !important;" value="<?php echo $template_select['sign_name']; ?>" class="input-common" /><span style="font-size:13px;">与阿里大鱼内短信签名保持一致!</span></div>
			<div class="bl">
	...
	<div class="save">
		...
		<a href="<?php echo __url('ADMIN_MAIN/config/notifyindex'); ?>">
...
function get_template_item($template_code){
	$.ajax({
		type : "post",
		url: "<?php echo __url('ADMIN_MAIN/Config/getTemplateItem'); ?>",
...
function template_submit(){
	...
	$.ajax({
		type : "post",
		url: "<?php echo __url('ADMIN_MAIN/config/updatenotifytemplate'); ?>",
