<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:46:"template/adminblue\System\dialogAlbumList.html";i:1504062309;s:45:"template/adminblue\controlCommonVariable.html";i:1503719297;s:34:"template/adminblue\pageCommon.html";i:1505550036;}*/ ?>
<html>
<head>
			...
			success : function(data) {
				...
				if (data["data"].length > 0) {
					for (var i = 0; i < data["data"].length; i++) {
						html += "<li title='"+data["data"][i]["pic_name"]+"'><img src='"
