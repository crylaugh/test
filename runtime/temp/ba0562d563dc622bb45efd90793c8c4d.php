<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:44:"template/adminblue\Goods\editGoodsBrand.html";i:1503280183;s:28:"template/adminblue\base.html";i:1508840920;s:45:"template/adminblue\controlCommonVariable.html";i:1503719297;s:32:"template/adminblue\urlModel.html";i:1504865854;s:34:"template/adminblue\pageCommon.html";i:1505550036;s:34:"template/adminblue\openDialog.html";i:1509005619;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	<input type="hidden" value="<?php echo $brand_info['brand_id']; ?>" id="brand_id" />
	<dl>
		<dt><span class="color-red">*</span>品牌名称:</dt>
		<dd>
			<input id="brand_name" type="text" value="<?php echo $brand_info['brand_name']; ?>" placeholder="请输入品牌名称" class="input-common"/>
	...
	<dl>
		...
		<dd>
			<input id="brand_initial" type="text" value="<?php echo $brand_info['brand_initial']; ?>" placeholder="请输入品牌首字母" class="input-common"/>
	...
	<dl>
		<dt>是否推荐</dt>
		<dd>
			<input id="brand_recommend" type="checkbox" class="checkbox" <?php if($brand_info['brand_recommend'] == 1): ?>checked="checked" <?php endif; ?> />
		</dd>
	</dl>
	<dl>
		...
		<dd>
			...
			<select id="category_id_1" name="account" class="form-control m-b select-common" onchange="changeCategory(1)" style="display: none;">
		...
		<dd>
			<div class="class-logo">
				...
				<?php if($brand_info['brand_pic'] == ''): ?>
					<img id="imgbrand_pic">
				<?php else: ?>	
					<img id="imgbrand_pic" src="<?php echo __IMG($brand_info['brand_pic']); ?>">
				<?php endif; ?>
				</p>
			</div>
			...
			<div class="upload-btn">
				<span>
					...
					<input type="hidden" id="brand_pic" value="<?php echo $brand_info['brand_pic']; ?>" />
				</span>
				<p><i class="fa fa-cloud-upload"></i>上传图片</p>
			</div>
			<p class="hint"><span style="color: orange;">建议使用宽200像素*高60像素内的GIF或PNG透明图片；点击下方"提交"按钮后生效。</span></p>
		</dd>
	</dl>
	<dl>
		<dt>品牌推荐广告图</dt>
		<dd>
			<div class="class-logo">
				...
				<?php if($brand_info['brand_ads'] == ''): ?>
					<img id="imgbrand_ads" class="imglogo" />
				<?php else: ?>
					<img id="imgbrand_ads" class="imglogo" src="<?php echo __IMG($brand_info['brand_ads']); ?>" />
				<?php endif; ?>
				</p>
			</div>
			...
			<div class="upload-btn">
				<span>
					...
					<input type="hidden" id="brand_ads" value="<?php echo $brand_info['brand_ads']; ?>" />
				</span>
				<p><i class="fa fa-cloud-upload"></i>上传图片</p>
			</div>
			<p class="hint"><span style="color: orange;">建议使用宽200像素*高60像素内的GIF或PNG透明图片；点击下方"提交"按钮后生效。</span></p>
	...
	<dl>
		<dt></dt>
		<dd><button class="btn-common btn-big" onclick="editGoodsBrand();">提交</button></dd>
	</dl>
</div>
<script>
function validation() {
...
// 		category_id_1.val("<?php echo $brand_info['category_id_1']; ?>");
// 		if (category_id_1.val() == 0 ) {
...
function editGoodsBrand() {
	...
	$.ajax({
		type : "post",
		url : "<?php echo __URL('ADMIN_MAIN/goods/updategoodsbrand'); ?>",
		data : {
			'brand_id' : brand_id,
		...
		success : function(data) {
			if (data["code"] > 0) {
				showMessage('success', "商品品牌修改成功","<?php echo __URL('ADMIN_MAIN/goods/goodsbrandlist'); ?>");
			} else {
