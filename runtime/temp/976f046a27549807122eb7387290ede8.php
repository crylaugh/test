<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:42:"template/adminblue\Goods\addGoodsSpec.html";i:1501579295;s:28:"template/adminblue\base.html";i:1508840920;s:45:"template/adminblue\controlCommonVariable.html";i:1503719297;s:32:"template/adminblue\urlModel.html";i:1504865854;s:34:"template/adminblue\pageCommon.html";i:1505550036;s:34:"template/adminblue\openDialog.html";i:1509005619;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	...
	<dl>
		...
		<dd>
			<input id="sort" type="text" value="255" onkeyup='this.value=this.value.replace(/\D/gi,"")' class="input-common"/>
		</dd>
	</dl>
	<dl>
	...
	<dl>
		...
		<dd>
			<label class="line-label"><input type="radio" name="show_type" id="show_type1" value="1" checked="checked" onchange="change_show_type(1)">文字</label>
	...
	<div class="table">
		...
		<div class="w100 spec_data">
			...
			<div class="inline-block w75">
				<input type="text" name="spec_value" style="margin-right: 20px;" class="input-common">
			</div>
	...
	<div style="text-align: center;">
		<button class="btn-common btn-big" onclick="addGoodsSpec();">提交</button>
	</div>
</div>
<script>
...
function addSpecValue(e){
	...
	if(show_type ==2){
		html += '<div class="inline-block w75" style="margin-right: 4px;"><input type="text" name="spec_value" style="margin-right:20px;" class="input-common">&nbsp;<input type="color" name="spec_value_data" style="width:60px;margin-top:5px;" class="input-common"/></div>';
	}else{
		html += '<div class="inline-block w75" style="margin-right: 4px;"><input type="text" name="spec_value" style="margin-right:20px;" class="input-common"></div>';
	}
...
function addGoodsSpec() {
	...
	$.ajax({
		type : "post",
		url : "<?php echo __URL('ADMIN_MAIN/goods/addgoodsspec'); ?>",
		data : {
			'spec_name' : spec_name,
			'sort' : sort,
		...
		success : function(data) {
			if (data["code"] > 0) {
				showMessage('success', "添加成功","<?php echo __URL('ADMIN_MAIN/goods/goodsspeclist'); ?>");
			} else {
