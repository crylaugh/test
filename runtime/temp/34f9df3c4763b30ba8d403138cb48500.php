<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:40:"template/adminblue\Config\seoConfig.html";i:1501559758;s:28:"template/adminblue\base.html";i:1508840920;s:45:"template/adminblue\controlCommonVariable.html";i:1503719297;s:32:"template/adminblue\urlModel.html";i:1504865854;s:34:"template/adminblue\pageCommon.html";i:1505550036;s:34:"template/adminblue\openDialog.html";i:1509005619;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	<dl>
		<dt>标题附加字：</dt>
		<dd>
			<input id="title" type="text" value="<?php echo $info['seo_title']; ?>" class="input-common" />
	...
	<dl>
		<dt>商城关键词：</dt>
		<dd>
			<input id="meta" type="text"  value="<?php echo $info['seo_meta']; ?>" class="input-common" />
	...
	<dl>
		<dt>关键词描述：</dt>
		<dd>
			<input id="desc" type="text" value="<?php echo $info['seo_desc']; ?>" class="input-common" />
	...
	<dl>
		<dt>其他页头信息：</dt>
		<dd>
			<textarea id="other" class="textarea input-common" maxlength="50"><?php echo $info['seo_other']; ?></textarea>
