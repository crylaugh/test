<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:44:"template/adminblue\System\updateShopAdv.html";i:1504769855;s:28:"template/adminblue\base.html";i:1508840920;s:45:"template/adminblue\controlCommonVariable.html";i:1503719297;s:32:"template/adminblue\urlModel.html";i:1504865854;s:34:"template/adminblue\pageCommon.html";i:1505550036;s:34:"template/adminblue\openDialog.html";i:1500263975;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	<dl>
		...
		<dd>
			<p><input id="adv_title" type="text" value="<?php echo $adv_info['adv_title']; ?>" class="input-common"></p>
	...
	<dl>
		...
		<dd>
			<div class="class-logo"><p><img id="imgLogo" <?php if($adv_info['adv_image'] != ''): ?> src="<?php echo __IMG($adv_info['adv_image']); ?>" <?php endif; ?> ></p></div>
	...
	<dl>
		<dt>背景色:</dt>
		<dd>
			<input id="background" type="color" style="width:60px;height:25px;" value="<?php echo $adv_info['background']; ?>" class="input-common"/>
		</dd>
	</dl>
	<dl>
		<dt><span class="color-red">*</span>链接地址:</dt>
		<dd>
			<p><input id="adv_url" type="text" value="<?php echo $adv_info['adv_url']; ?>" class="input-common"></p>
	...
	<dl>
		...
		<dd>
			<p><input id="slide_sort" type="number" value="<?php echo $adv_info['slide_sort']; ?>" class="input-common"></p>
...
<input type="hidden" id="ap_id" value="<?php echo $adv_info['ap_id']; ?>">
...
function updateShopAdvAjax() {
	...
	if($("#Logo").val().length > 0){
		...
		var adv_image = "<?php echo $adv_info['adv_image']; ?>"; 
	}
	...
	if(verify(adv_title,adv_image,adv_url,slide_sort)){
		$.ajax({
			type : "post",
			url : "<?php echo __URL('ADMIN_MAIN/system/updateshopadv'); ?>",
			data : {
				'adv_id' : adv_id,
				'adv_title' : adv_title,
				'ap_id' : ap_id,
