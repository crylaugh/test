<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:39:"template/adminblue\Config\constant.html";i:1508729673;s:28:"template/adminblue\base.html";i:1508840920;s:45:"template/adminblue\controlCommonVariable.html";i:1503719297;s:32:"template/adminblue\urlModel.html";i:1504865854;s:34:"template/adminblue\pageCommon.html";i:1505550036;s:34:"template/adminblue\openDialog.html";i:1509005619;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	<dl>
	<?php if(is_array($res) || $res instanceof \think\Collection || $res instanceof \think\Paginator): if( count($res)==0 ) : echo "" ;else: foreach($res as $k=>$info): ?>
		<dt><?php echo $info[name]; ?>:</dt>
		<dd>
			<input id="constantId<?php echo $k; ?>" type="hidden" value="<?php echo $info[id]; ?>" />
			<input id="constant<?php echo $k; ?>" type="text" value="<?php echo $info[val]; ?>" />
<!-- 			<p class="hint">提现金额将不小于此值才能提现</p> -->
			<button  onclick="setConstantAjax(<?php echo $k; ?>);">提交</button>
		</dd>
	<?php endforeach; endif; else: echo "" ;endif; ?>
	</dl>
...
<script>
	...
	function setConstantAjax($k) {
		...
		var constantId = $("#constantId"+$k).val();
			$.ajax({
				type : "post",
				url : "<?php echo __URL('ADMIN_MAIN/config/updateConstant'); ?>",
				data : {
					'id' : constantId,
					'val' : constant
