<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:45:"template/adminblue\Config\expressMessage.html";i:1501559758;s:28:"template/adminblue\base.html";i:1508840920;s:45:"template/adminblue\controlCommonVariable.html";i:1503719297;s:32:"template/adminblue\urlModel.html";i:1504865854;s:34:"template/adminblue\pageCommon.html";i:1505550036;s:34:"template/adminblue\openDialog.html";i:1509005619;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	...
	<dl>
		<dt>APPID:</dt>
		<dd>
			<input id="appid" type="text" value="<?php echo $emconfig['value']['appid']; ?>" class="input-common"/>
	...
	<dl>
		<dt>APPKEY:</dt>
		<dd>
			<input id="appkey" type="text" value="<?php echo $emconfig['value']['appkey']; ?>" class="input-common"/>
			<p class="hint">应用密钥</p>
		</dd>
	</dl>
	<dl>
...
function setExpressConfigAjax(){
	...
	$.ajax({
		...
		success : function(data){
			if(data['code'] > 0){
				showMessage('success', data["message"],"<?php echo __URL('ADMIN_MAIN/config/expressmessage'); ?>");
			}else{
