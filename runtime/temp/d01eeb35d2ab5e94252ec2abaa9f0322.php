<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:43:"template/wap\default\Pay\payCallbackPc.html";i:1503280183;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
	...
	<div class="layout cart-btn-wrap">
		<div class="js-main container border border-gray-white text-default">
			<div style="padding:40px;">
				...
				<p style="text-indent: 40px;">
					<?php echo lang('order_number'); ?>：<span class="text-sub"><?php echo $out_trade_no; ?></span>
				</p>
			</div>
