<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:45:"template/adminblue\Member\addMemberLevel.html";i:1508497329;s:28:"template/adminblue\base.html";i:1505297354;s:45:"template/adminblue\controlCommonVariable.html";i:1503719297;s:32:"template/adminblue\urlModel.html";i:1504865854;s:34:"template/adminblue\pageCommon.html";i:1505550036;s:34:"template/adminblue\openDialog.html";i:1500263975;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	...
	<dl>
		...
		<dd class="total">
			<div>
				<input type="checkbox" value="1" />直推会员&nbsp;&nbsp;&nbsp;
				<input class="input-common" onkeyup="value=value.replace(/[^\d+(\.\d+)?]/g,'')" type="number" min="0" id="min_integral" style="margin-bottom: 0px; " placeholder="0">人&nbsp;&nbsp;&nbsp;
				<span class="hint">设置会员等级所需要的直推会员人数且必须大于等于0</span>
			</div>
			<div>
				<input type="checkbox" value="2" />团队会员&nbsp;&nbsp;&nbsp;
				<input class="input-common" onkeyup="value=value.replace(/[^\d+(\.\d+)?]/g,'')" type="number" min="0" id="quota" style="margin-bottom: 0px; " placeholder="0">人&nbsp;&nbsp;&nbsp;
				<span class="hint">设置会员等级所需要的团队会员人数且必须大于等于0</span>
			</div>
			<label for="navigationtype1"><input type="radio" value="1" name="navigationtype" id="navigationtype1" checked="checked" />或</label>
			<label for="navigationtype2"><input type="radio" value="2" name="navigationtype" id="navigationtype2" />且</label>
	...
	<dl>
		...
		<dd>
			<input class="input-common type="text" id="goods_discount">
...
function addGift(){
	...
	$.ajax({
		type : "post",
		url : "<?php echo __url('ADMIN_MAIN/member/addmemberlevel'); ?>",
		data : {
