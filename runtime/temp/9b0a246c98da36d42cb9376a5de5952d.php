<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:42:"template/wap\default\\Member\recharge.html";i:1502935840;s:30:"template/wap\default\base.html";i:1507430043;s:34:"template/wap\default\urlModel.html";i:1505377008;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
function calculateRecharge(){
    ...
    $.ajax({
        url: "<?php echo __URL('APP_MAIN/member/createrechargeorder'); ?>",
        type: "post",              
        async: false,
...
<section class="head">
	...
	<div class="head-title"><?php echo lang('recharge_balance'); ?></div>
</section>
...
<div id="main" class="detail-main">
	<div class="payment"><span><?php echo lang('member_amount_money'); ?></span><input class="pay-money" id="pay_money"  type="number" placeholder ="<?php echo lang('member_input_balance'); ?>"></div>
	...
	<button class="alipay" type="button" onclick="calculateRecharge()"><?php echo lang('confirm_payment'); ?></button>
	</section>
</div>
