<?php if (!defined('THINK_PATH')) exit(); /*a:8:{s:39:"template/adminblue\Order\orderList.html";i:1509761533;s:28:"template/adminblue\base.html";i:1508840920;s:45:"template/adminblue\controlCommonVariable.html";i:1503719297;s:32:"template/adminblue\urlModel.html";i:1504865854;s:34:"template/adminblue\pageCommon.html";i:1505550036;s:34:"template/adminblue\openDialog.html";i:1509005619;s:41:"template/adminblue\Order\orderAction.html";i:1505305443;s:47:"template/adminblue\Order\orderRefundAction.html";i:1501666681;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
function CheckAll(event){
	var checked = event.checked;
	$(".table-class tbody input[type = 'checkbox']").not(":disabled").prop("checked",checked);
}
			...
			if (data["data"].length > 0) {
				...
				for (var i = 0; i < data["data"].length; i++) {
					...
					if(data["data"][i]["order_status"] != 5){
						html += '<td colspan="7"><input id="'+out_trade_no+'" type="checkbox" value="'+order_id+'" name="sub" disabled>';
					}else{
						html += '<td colspan="7"><input id="'+out_trade_no+'" type="checkbox" value="'+order_id+'" name="sub">';
					}
					html +='<span>订单编号：'+order_no+' 交易号：'+out_trade_no+'</span><span>下单时间：'+create_time+'</span><span style="margin-left:30px;">消费积分：'+data["data"][i]["order_item_list"][0]["jifen"]+'</span>';
