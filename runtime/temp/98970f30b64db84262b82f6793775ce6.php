<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:48:"template/adminblue\Member\updateMemberLevel.html";i:1508497083;s:28:"template/adminblue\base.html";i:1508840920;s:45:"template/adminblue\controlCommonVariable.html";i:1503719297;s:32:"template/adminblue\urlModel.html";i:1504865854;s:34:"template/adminblue\pageCommon.html";i:1505550036;s:34:"template/adminblue\openDialog.html";i:1509005619;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	<dl>
		...
		<dd>
			<input type="text" id="level_name" value="<?php echo $info['level_name']; ?>" class="input-common">
	...
	<dl>
		...
		<dd class="total">
			<div>
				<input type="checkbox" value="1" <?php if(($info['upgrade']==1) OR ($info['upgrade']==3)): ?>checked="checked"<?php endif; ?>/>直推会员&nbsp;&nbsp;&nbsp;
				<input class="input-common" onkeyup="value=value.replace(/[^\d+(\.\d+)?]/g,'')"  type="number" min="0" id="min_integral" style="margin-bottom: 0px; " value="<?php echo $info['min_integral']; ?>" placeholder="0">人&nbsp;&nbsp;&nbsp;
				<span class="hint">设置会员等级所需要的直推会员人数且必须大于等于0</span>
			</div>
			<div>
				<input type="checkbox" value="2" <?php if(($info['upgrade']==2) OR ($info['upgrade']==3)): ?>checked="checked"<?php endif; ?>/>团队会员&nbsp;&nbsp;&nbsp;
				<input class="input-common" onkeyup="value=value.replace(/[^\d+(\.\d+)?]/g,'')"  type="number" min="0" id="quota" style="margin-bottom: 0px; " value="<?php echo $info['quota']; ?>" placeholder="0">人&nbsp;&nbsp;&nbsp;
				<span class="hint">设置会员等级所需要的团队会员人数且必须大于等于0</span>
			</div>
			<label for="navigationtype1"><input type="radio" value="1" name="navigationtype" id="navigationtype1" <?php if($info['relation'] == 1): ?>checked="checked"<?php endif; ?>/>或</label>
			<label for="navigationtype2"><input type="radio" value="2" name="navigationtype" id="navigationtype2" <?php if($info['relation'] == 2): ?>checked="checked"<?php endif; ?>/>且</label>
	...
	<dl>
		<dt><span class="required">*</span>日封顶:</dt>
		<dd>
			<input class="input-mini input-common" type="text" id="goods_discount" value="<?php echo $info['goods_discount']; ?>">
	...
	<dl>
		<dt>等级描述:</dt>
		<dd>
			<textarea id="desc" class="input-common"><?php echo $info['desc']; ?></textarea>
...
//保存
function addGift(){
	var level_id = <?php echo $info['level_id']; ?>;
	...
	$.ajax({
		type : "post",
		url : "<?php echo __URL('ADMIN_MAIN/member/updatememberlevel'); ?>",
		data : {
			'level_id':level_id,
