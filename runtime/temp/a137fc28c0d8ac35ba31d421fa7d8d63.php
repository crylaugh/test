<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:40:"template/adminblue\Config\helpClass.html";i:1501559758;s:28:"template/adminblue\base.html";i:1508840920;s:45:"template/adminblue\controlCommonVariable.html";i:1503719297;s:32:"template/adminblue\urlModel.html";i:1504865854;s:34:"template/adminblue\pageCommon.html";i:1505550036;s:34:"template/adminblue\openDialog.html";i:1500263975;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<li><a href="ADMIN_MAIN/config/addhelpclass"><i class="fa fa-plus-circle"></i>&nbsp;添加帮助类型</a></li>
...
function LoadingInfo(page_index) {
	...
	$.ajax({
		type : "post",
		url : "<?php echo __URL('ADMIN_MAIN/config/helpclass'); ?>",
		data : {
...
function updateClass(index,class_id){
	...
	$.ajax({
		type:"post",
		url:"<?php echo __URL('ADMIN_MAIN/config/updateclass'); ?>",
	...
	$( "#dialog" ).dialog({
		buttons: {
			"确定": function() {
				...
				$.ajax({
					type : "post",
					url: "<?php echo __URL('ADMIN_MAIN/config/classdelete'); ?>",
					data: { "class_id": class_id},
					success : function(data) {
						if(data["code"] > 0 ){
							showMessage('success', data["message"],"<?php echo __URL('ADMIN_MAIN/config/helpclass'); ?>");
						}else{
