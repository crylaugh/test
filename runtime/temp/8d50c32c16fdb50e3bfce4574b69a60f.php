<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:44:"template/adminblue\Upgrade\onlineUpdate.html";i:1501579284;s:28:"template/adminblue\base.html";i:1505297354;s:45:"template/adminblue\controlCommonVariable.html";i:1503719297;s:32:"template/adminblue\urlModel.html";i:1504865854;s:34:"template/adminblue\pageCommon.html";i:1505550036;s:34:"template/adminblue\openDialog.html";i:1500263975;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		...
		<table>
			<tbody>
				...
				<tr>
					<td>授权账号：
					<?php if($result != ''): ?>
						<?php echo $devolution_user_name; ?> &nbsp;&nbsp;<a href="javascript:;" target="_blank" style="color:#666;" onclick="bind()">重新绑定</a>
					<?php else: ?>
					&nbsp;&nbsp;<a href="javascript:;" target="_blank" style="color:#666;" onclick="bind()">立即绑定</a>
					<?php endif; ?>
					</td>
				</tr>
				<tr><td>站点URL：<?php echo $result['data']['devolution_url']; ?></td></tr>
				<tr><td>授权时间：
				...
				<tr><td >服务器版本：<?php echo $latestVersion['data']['latest_version']; ?></td></tr>
				<tr><td >授权版本：<?php echo $result['data']['devolution_version_name']; ?></td></tr>
				<?php if($result != ''): ?>
