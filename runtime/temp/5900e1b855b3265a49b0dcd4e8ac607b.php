<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:47:"template/adminblue\Config\registerAndVisit.html";i:1505382299;s:28:"template/adminblue\base.html";i:1508840920;s:45:"template/adminblue\controlCommonVariable.html";i:1503719297;s:32:"template/adminblue\urlModel.html";i:1504865854;s:34:"template/adminblue\pageCommon.html";i:1505550036;s:34:"template/adminblue\openDialog.html";i:1500263975;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	...
	<dl>
		<dt>用户名保留关键字:</dt>
		<dd>
			<textarea rows="2" id="name_keyword" class="textarea input-common" maxlength="50"><?php echo $register_and_visit["name_keyword"]; ?></textarea>
		...
		<dd>
			<div class="controls">
				<?php if($register_and_visit['is_requiretel'] == 1): ?>
					...
					<p class="hint">需用户登录或注册会员后,将拉取的微信会员信息和当前用户进行绑定</p>
					<label class="radio inline"><input type="radio" name="is_requiretel" value="0">自动</label>
					<p class="hint">会员进入微信端会自动拉取会员信息自动注册</p>
				<?php else: ?>
