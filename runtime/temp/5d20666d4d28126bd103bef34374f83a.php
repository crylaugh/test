<?php if (!defined('THINK_PATH')) exit(); /*a:19:{s:40:"template/shop\blue\\Goods\goodsList.html";i:1504086850;s:28:"template/shop\blue\base.html";i:1505297202;s:32:"template/shop\blue\urlModel.html";i:1505377008;s:34:"template/shop\blue\controlTop.html";i:1504180836;s:41:"template/shop\blue\controlHeadSerach.html";i:1504508481;s:44:"template/shop\blue\controlHeadSearchAdv.html";i:1503280183;s:43:"template/shop\blue\controlHeadGoodType.html";i:1502679157;s:40:"template/shop\blue\controlCommonNav.html";i:1502706001;s:43:"template/shop\blue\controlRightSidebar.html";i:1503280183;s:60:"template/shop\blue\Goods\controlGoodsCategoryConditions.html";i:1505355683;s:46:"template/shop\blue\Goods\controlGoodsLeft.html";i:1503280183;s:45:"template/shop\blue\Goods\controlGoodList.html";i:1503660336;s:59:"template/shop\blue\Goods\controlPopUpGoodsSkuAttribute.html";i:1502679157;s:41:"template/shop\blue\controlCommonPage.html";i:1502679157;s:44:"template/shop\blue\controlLoveOrHistory.html";i:1503280183;s:45:"template/shop\blue\controlBottomLinkHelp.html";i:1503280183;s:37:"template/shop\blue\controlBottom.html";i:1501752182;s:36:"template/shop\blue\controlLogin.html";i:1505297202;s:37:"template/shop\blue\baidu_js_push.html";i:1499844478;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<!-- 					<?php endif; ?> -->
					<div class="p-img">
						<a target="_blank" title="<?php echo $goodsinfo['goods_info']['goods_name']; ?>" href="<?php echo __URL('SHOP_MAIN/goods/goodsinfo','goodsid='.$goodsinfo['goods_id']); ?>"> 
							<img src="<?php echo __IMG($goodsinfo['picture_info']['pic_cover_mid']); ?>" />
						</a>
					</div>
					<div class="p-name">
							...
							<div class="fr">
								<div class="item-add-cart">
									<?php if($goods['stock'] != '0'): ?>
										<a href="javascript:ShowGoodsAttribute(<?php echo $goods['goods_id']; ?>,'<?php echo $goods['goods_name']; ?>',<?php echo $goods['pic_id']; ?>,this,<?php if($goods['max_buy']==0): ?><?php echo $goods['stock']; else: ?><?php echo $goods['max_buy']; endif; ?>,<?php echo $goods['state']; ?>);" class="add-cart" title="<?php echo lang('goods_add_cart'); ?>"></a>
									<?php else: ?>
										<a href="javascript:;" class="add-cart" title="<?php echo lang('goods_add_cart'); ?>" style="background-image: url(__TEMP__/<?php echo $style; ?>/public/images/gray-cart.png)"></a>
...
<div id="pagination" class="page" >
	...
	<div class="page-num fr">
		...
		<div id="page_list" style="float: left;<?php echo $path_info; ?>">
			...
			<!-- 总页数小于总页码时就都显示 -->
			<?php if($page_count <= $page_num): $__FOR_START_12515__=1;$__FOR_END_12515__=$page_count+1;for($i=$__FOR_START_12515__;$i < $__FOR_END_12515__;$i+=1){ if($i == $page): ?>
			...
			<?php elseif($page <= ($page_num-1)/2): $__FOR_START_21176__=1;$__FOR_END_21176__=$page_num+1;for($i=$__FOR_START_21176__;$i < $__FOR_END_21176__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="<?php echo __URL('SHOP_MAIN/'.$path_info.'?page='.$i.$query_string); ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } ?>
			<!-- 如果总页数等于当前页 或者 总页数小于当前页加上页码总数平均值显示 -->
			<?php elseif($page_count == $page or $page_count <= $page+($page_num-1)/2): $__FOR_START_27552__=$page_count-$page_num+1;$__FOR_END_27552__=$page_count+1;for($i=$__FOR_START_27552__;$i < $__FOR_END_27552__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="<?php echo __URL('SHOP_MAIN/'.$path_info.'?page='.$i.$query_string); ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } ?>
			<!-- 否则就正常显示 -->
			<?php else: $__FOR_START_10800__=$page-($page_num-1)/2;$__FOR_END_10800__=$page+($page_num-1)/2+1;for($i=$__FOR_START_10800__;$i < $__FOR_END_10800__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="<?php echo __URL('SHOP_MAIN/'.$path_info.'?page='.$i.$query_string); ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } endif; ?>
