<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:40:"template/adminblue\Extend\hooksList.html";i:1505297354;s:28:"template/adminblue\base.html";i:1505297354;s:45:"template/adminblue\controlCommonVariable.html";i:1503719297;s:32:"template/adminblue\urlModel.html";i:1504865854;s:34:"template/adminblue\pageCommon.html";i:1505550036;s:34:"template/adminblue\openDialog.html";i:1500263975;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<li><a href="<?php echo __URL('ADMIN_MAIN/extend/addhooks'); ?>"><i class="fa fa-plus-circle"></i>&nbsp;添加钩子</a></li>
...
function LoadingInfo(page_index) {
	$.ajax({
		type : "post",
		url : "<?php echo __URL('ADMIN_MAIN/extend/hookslist'); ?>",
	...
	$("#dialog").dialog({
		buttons: {
			"确定": function() {
				...
				$.ajax({
					type : "post",
					url : "<?php echo __URL('ADMIN_MAIN/extend/deleteHooks'); ?>",
					data : { "id" : id },
					success : function(data) {
						if (data["code"] > 0) {
							showMessage('success', "删除成功","<?php echo __URL('ADMIN_MAIN/extend/hookslist'); ?>");
						}else{
