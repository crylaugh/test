<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:43:"template/adminblue\\Promotion\integral.html";i:1502419154;s:28:"template/adminblue\base.html";i:1505297354;s:45:"template/adminblue\controlCommonVariable.html";i:1503719297;s:32:"template/adminblue\urlModel.html";i:1504865854;s:34:"template/adminblue\pageCommon.html";i:1505550036;s:34:"template/adminblue\openDialog.html";i:1500263975;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	<dl>
		<dt>会员注册送积分:</dt>
		<dd>
			<p><input id="reg_member_self_point" type="number" min="0" value="<?php echo $res['reg_member_self_point']; ?>"  onkeyup="value=value.replace(/[^\d+(\.\d+)?]/g,'')" class="input-common"></p>
	...
	<dl>
		<dt>签到送积分:</dt>
		<dd>
			<p><input id="sign_point" type="number" value="<?php echo $res['sign_point']; ?>"  min="0" onkeyup="value=value.replace(/[^\d+(\.\d+)?]/g,'')" class="input-common" ></p>
			<p class="error">请输入阿里旺旺</p>
		</dd>
	</dl>
		<dl>
	...
	<dl>
		<dt>分享送积分:</dt>
		<dd>
			<p><input id="share_point" type="number" value="<?php echo $res['share_point']; ?>" min="0"  onkeyup="value=value.replace(/[^\d+(\.\d+)?]/g,'')" class="input-common" ></p>
			<p class="error">请输入阿里旺旺</p>
		</dd>
	</dl>
	<dl>
	...
	<dl>
		<dt>点赞送积分:</dt>
		<dd>
			<p><input id="click_point" type="number" value="<?php echo $res['click_point']; ?>" min="0"  onkeyup="value=value.replace(/[^\d+(\.\d+)?]/g,'')" class="input-common" ></p>
		</dd>
	</dl>
	...
	<dl>
		<dt>评论送积分:</dt>
		<dd>
			<p><input id="comment_point" type="number" value="<?php echo $res['comment_point']; ?>" min="0"  onkeyup="value=value.replace(/[^\d+(\.\d+)?]/g,'')" class="input-common" ></p>
		</dd>
	</dl>
	<dl>
		<dt></dt>
