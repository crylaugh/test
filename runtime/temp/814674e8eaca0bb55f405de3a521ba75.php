...
<li><a href="<?php echo __URL('ADMIN_MAIN/goods/addgoodscategory'); ?>"><i class="fa fa-plus-circle"></i>&nbsp;添加商品分类</a></li>
	...
	<tbody>
		<?php if(is_array($category_list) || $category_list instanceof \think\Collection || $category_list instanceof \think\Paginator): if( count($category_list)==0 ) : echo "" ;else: foreach($category_list as $key=>$v1): ?>
			<tr class="pid_0" style="height: 30px;">
				...
				<td style="text-align: center;"><input type="text" class="sort input-common" fieldid="<?php echo $v1['category_id']; ?>" fieldname="sort" value="<?php echo $v1['sort']; ?>" size="1"></td>
