<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:44:"template/adminblue\Config\copyrightinfo.html";i:1503280183;s:28:"template/adminblue\base.html";i:1508840920;s:45:"template/adminblue\controlCommonVariable.html";i:1503719297;s:32:"template/adminblue\urlModel.html";i:1504865854;s:34:"template/adminblue\pageCommon.html";i:1505550036;s:34:"template/adminblue\openDialog.html";i:1509005619;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	<dl>
		...
		<dd>
			<div class="class-logo">
				<p>
					<img id="imglogo" src="<?php echo __IMG($info['copyright_logo']); ?>">
				</p>
			</div>
	...
	<dl>
		<dt>备案号：</dt>
		<dd>
			<input id="meta" type="text"  value="<?php echo $info['copyright_meta']; ?>" class="input-common" />
<!-- 			<p class="hint">Keywords项出现在页面头部的标签中，用于记录本页面的关键字，多个关键字请用分隔符分隔</p> -->
	...
	<dl>
		<dt>公司名称：</dt>
		<dd>
			<input id="companyname" type="text" value="<?php echo $info['copyright_companyname']; ?>" class="input-common" />
<!-- 			<p class="hint">Description出现在页面头部的Meta标签中，用于记录本页面的摘要与描述，建议不超过80个字</p> -->
	...
	<dl>
		<dt>版权链接：</dt>
		<dd>
			<input id="link" type="text"  value="<?php echo $info['copyright_link']; ?>" class="input-common" />
<!-- 			<p class="hint">Keywords项出现在页面头部的标签中，用于记录本页面的关键字，多个关键字请用分隔符分隔</p> -->
		</dd>
	</dl>
	<dl>
		<dt>版权信息：</dt>
		<dd>
			<textarea id="desc" class="textarea input-common" maxlength="50"><?php echo $info['copyright_desc']; ?></textarea>
