<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:45:"template/adminblue\Config\areaManagement.html";i:1501559758;s:28:"template/adminblue\base.html";i:1505297354;s:45:"template/adminblue\controlCommonVariable.html";i:1503719297;s:32:"template/adminblue\urlModel.html";i:1504865854;s:34:"template/adminblue\pageCommon.html";i:1505550036;s:34:"template/adminblue\openDialog.html";i:1500263975;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<li><a href="javascript:;" onclick="addProvince()"><i class="fa fa-plus-circle"></i>&nbsp;添加一级地区</a></li>
...
<div class="areaTable">
	...
	<div class="areaTr pid_0" id="province_id_<?php echo $v1['province_id']; ?>" isClick="false">
		...
		<div class="areaTd" style="width: 55px;">
			<input type="text" class="sort input-common" fieldid="<?php echo $v1['province_id']; ?>" fieldname="sort" value="<?php echo $v1['sort']; ?>"  onkeyup="this.value=this.value.replace(/\D/g,'')" size="1" onchange="updateRegionAjax(1,1,this);" style="width: 32px;" />
		</div>
		<div class="areaTd province_<?php echo $v1['province_id']; ?>" style="width: 335px;text-align: left;">
			<input type="text" class="areaName input-common" style="width: 206px;text-align: left;" fieldid="<?php echo $v1['province_id']; ?>" value="<?php echo $v1['province_name']; ?>" onchange="updateRegionAjax(1,2,this);" />
		</div>
		<div class="areaTd province_<?php echo $v1['province_id']; ?>" style="width: 90px;">
			<?php if($v1['area_name'] !=''): ?>
			...
			<div class="modal-body">
				<table class="table-class">
					...
					<tr>
						...
						<td><input type="text" id="regionSort" onkeyup="this.value=this.value.replace(/\D/g,'')" class="input-common" /></td>
					</tr>
				</table>
			</div>
			<div class="modal-footer">
				<input type="hidden" id="evaluate_id" />
				<button type="button" class="btn btn-primary" onclick="addOrUpdateAjax()">保存</button>
		...
		success : function(data){
			if(data.length > 0){
				...
				for (var i = 0; i < data.length; i++) {
					...
					addInfo += '<input type="text" class="sort input-common" fieldid="'+data[i]['city_id']+'" fieldname="sort" value="'+data[i]['sort']+'" size="1" onchange="updateRegionAjax(2,1,this);" style="width: 32px;"></div>';
					addInfo += '<div class="areaTd city_'+data[i]['city_id']+'" style="width: 335px;text-align: left;">';
					addInfo += '<span style="color: #ccc;">|——</span><input type="text" class="areaName input-common" style="width: 206px;text-align: left;" fieldid="'+data[i]['city_id']+'" value="'+data[i]['city_name']+'"  onchange="updateRegionAjax(2,2,this);"></div>';
		...
		success : function(data){
			if(data.length > 0){
				...
				for (var i = 0; i < data.length; i++) {
					...
					addInfo += '</div>';
					addInfo += '<div class="areaTd" style="width: 55px;">';
					addInfo += '<input type="text" class="sort input-common" fieldid="'+data[i]['district_id']+'" fieldname="sort" value="'+data[i]['sort']+'"  size="1" onchange="updateRegionAjax(3,1,this);" style="width: 32px;"></div>';
					addInfo += '<div class="areaTd district_'+data[i]['district_id']+'" style="width: 349px;text-align: left;">';
					addInfo += '<span style="color: #ccc;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|——</span><input type="text" class="areaName input-common" style="width: 206px;text-align: left;" fieldid="'+data[i]['district_id']+'" value="'+data[i]['district_name']+'"  onchange="updateRegionAjax(3,2,this);"></div>';
		...
		buttons: {
			...
			$(this).dialog('close');
				$.ajax({
					...
					success:function (data) {
						if(data['code'] > 0){
							showMessage("success", "删除成功", "<?php echo __URL('ADMIN_MAIN/config/areamanagement'); ?>");
						}else{
							$("#dialog").dialog({
								 buttons: {
									"确定,#e57373": function() {
		...
		success : function(data){
			...
			if(data['code']>0){
				if(type == 1){
					...
					addInfo += '<div class="areaTd" style="width: 55px;">';
					addInfo += '<input type="text" class="sort input-common" fieldid="'+data['code']+'" fieldname="sort" value="'+regionSort+'"  size="1" onchange="updateRegionAjax(2,1,this);" style="width: 32px;"></div>';
					addInfo += '<div class="areaTd city_'+data['code']+'" style="width: 335px;text-align: left;">';
					addInfo += '<span style="color: #ccc;">|——</span><input type="text" class="areaName input-common" style="width: 206px;text-align: left;" fieldid="'+data['code']+'" value="'+regionName+'" onchange="updateRegionAjax(2,2,this);"></div>';
				...
				if(type == 2){
					...
					addInfo += '</div>';
					addInfo += '<div class="areaTd" style="width: 55px;">';
					addInfo += '<input type="text" class="sort input-common" fieldid="'+data['code']+'" fieldname="sort" value="'+regionSort+'"  size="1" onchange="updateRegionAjax(3,1,this);" style="width: 32px;"></div>';
					addInfo += '<div class="areaTd district_'+data['code']+'" style="width: 335px;text-align: left;">';
					addInfo += '<span style="color: #ccc;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|——</span><input type="text" class="areaName input-common" style="width: 206px;text-align: left;" fieldid="'+data['code']+'" value="'+regionName+'"  onchange="updateRegionAjax(3,2,this);"></div>';
				...
				if(type == 6){
					...
					addInfo += '<div class="areaTd" style="width: 10px;"></div>';
					addInfo += '<div class="areaTd" style="width: 55px;">';
					addInfo += '<input type="text" class="sort input-common" fieldid="'+data['code']+'" fieldname="sort" value="'+regionSort+'" size="1" onchange="updateRegionAjax(1,1,this);" style="width: 32px;"></div>';
					addInfo += '<div class="areaTd province_'+data['code']+'" style="width: 335px;text-align: left;">';
					addInfo += '<input type="text" class="areaName input-common" style="width: 206px;text-align: left;" fieldid="'+data['code']+'" value="'+regionName+'" onchange="updateRegionAjax(1,2,this);"></div>';
