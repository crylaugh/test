<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:48:"template/adminblue\Promotion\updateDiscount.html";i:1503280183;s:28:"template/adminblue\base.html";i:1508840920;s:45:"template/adminblue\controlCommonVariable.html";i:1503719297;s:32:"template/adminblue\urlModel.html";i:1504865854;s:45:"template/adminblue\Promotion\selectGoods.html";i:1503280183;s:34:"template/adminblue\pageCommon.html";i:1505550036;s:34:"template/adminblue\openDialog.html";i:1509005619;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	<dl>
		<dt>活动名称:</dt>
		<dd><input type="text" id="discount_name" maxlength="10" value="<?php echo $info['discount_name']; ?>" class="input-common"><p class="error">请输入活动名称</p></dd>
		
	</dl>
	<dl>
		<dt>活动有效期:</dt>
		<dd>
			<input class="input-medium input-common" type="text" id="start_time" value="<?php echo getTimeStampTurnTime($info['start_time'] ); ?>" style="width:250px;"onclick="WdatePicker({skin:'twoer',dateFmt:'yyyy-MM-dd HH:mm:ss'})">
			<span class="mlr5">-</span> 
			<input class="input-medium input-common" size="15"type="text" id="end_time" value="<?php echo getTimeStampTurnTime($info['end_time'] ); ?>" style="width:250px;"onclick="WdatePicker({skin:'twoer',dateFmt:'yyyy-MM-dd HH:mm:ss'})">
...
<input type="hidden" id="discount_id" value="<?php echo $info['discount_id']; ?>">
<script>
$(function(){
	$('.type_dl dd').hide();
	$("#some_pro").show();
	...
	$goods_selected_array = <?php echo $info; ?>.goods_list;
	$goods_id_selected_array = <?php echo $info; ?>.goods_id_array;
	LoadingInfo(1);
...
function updateDiscount(){
	...
	if(verify(discount_name, start_time, end_time, goods_id_array)){
		...
		$.ajax({
			type : "post",
			url : "<?php echo __URL('ADMIN_MAIN/promotion/updatediscount'); ?>",
			data : {
