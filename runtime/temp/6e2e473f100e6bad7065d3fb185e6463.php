<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:40:"template/wap\default\\Member\my_son.html";i:1508826949;s:30:"template/wap\default\base.html";i:1507430043;s:34:"template/wap\default\urlModel.html";i:1505377008;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<link href="__TEMP__/<?php echo $style; ?>/public/css/my/tbstyle.css" type="text/css" rel="stylesheet" media="all" />
    <link rel="stylesheet" type="text/css" href="__TEMP__/<?php echo $style; ?>/public/css/my/member.css">
...
<?php foreach($son as $vo): ?> 
	<div class="wdtd_div">
		...
		<img src="__TEMP__/<?php echo $style; ?>/public/images/my/touxiang.gif">
			<span><?php echo $vo['real_name']; ?></span><br>
			<span><?php echo $vo['user_tel']; ?></span>
		</div>
		<div class="f_r">
			点股数量：<?php echo $vo['level']['max_ji']; ?>/<?php echo $vo['level']['reduce_ji']; ?>/<?php echo $vo['level']['present_ji']; ?>
		</div>
