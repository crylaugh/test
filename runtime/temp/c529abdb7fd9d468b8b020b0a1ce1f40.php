<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:43:"template/adminblue\Config\helpDocument.html";i:1501559758;s:28:"template/adminblue\base.html";i:1508840920;s:45:"template/adminblue\controlCommonVariable.html";i:1503719297;s:32:"template/adminblue\urlModel.html";i:1504865854;s:34:"template/adminblue\pageCommon.html";i:1505550036;s:34:"template/adminblue\openDialog.html";i:1500263975;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<li><a href="<?php echo __URL('ADMIN_MAIN/config/adddocument'); ?>"><i class="fa fa-plus-circle"></i>&nbsp;添加帮助内容</a></li>
...
function updateDocument(id,index,class_id){
	...
	$.ajax({
		type:"post",
		url:"<?php echo __URL('ADMIN_MAIN/config/updatedocument'); ?>",
		...
		buttons: {
			"确定": function() {
				...
				$.ajax({
					...
					success : function(data) {
						if(data["code"] > 0 ){
							showMessage('success', data["message"],"<?php echo __URL('ADMIN_MAIN/config/helpdocument'); ?>");
						}else{
