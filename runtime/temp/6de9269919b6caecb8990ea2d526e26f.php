<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:39:"template/wap\default\\Member\agent.html";i:1509600126;s:30:"template/wap\default\base.html";i:1507430043;s:34:"template/wap\default\urlModel.html";i:1505377008;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
function subAgent(){
    ...
    $.ajax({
        url: "<?php echo __URL('APP_MAIN/member/createagentorder'); ?>",
        type: "post",              
        async: false,
...
<div id="main" class="detail-main">
	...
	<button class="alipay" type="button" onclick="subAgent()"><?php echo lang('confirm_payment'); ?></button>
	</section>
</div>
