<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:47:"template/wap\default\\Member\member_wallet.html";i:1509333157;s:30:"template/wap\default\base.html";i:1507430043;s:34:"template/wap\default\urlModel.html";i:1505377008;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="wdsy_head" style="margin-top: 45px;">
	<div class="wdsy_head_one">
			...
			<p style="font-size:64px;line-height:64px"><a href="#"><?php echo $point_sum; ?></a></p>
	</div>
...
<dl class="wdsy_wddl">
	...
	<dd>
		<ul>
			<li>
			<a href="<?php echo __URL('APP_MAIN/member/my_son?id=1'); ?>">
				<p><img src="__TEMP__/<?php echo $style; ?>/public/images/my/people1.png"></p>
				<p>一级会员</p>
				<p style="color:#2ca1d1"><?php if($son): ?><?php echo $son; else: ?>0<?php endif; ?></p>
			</a>
			</li>
			<li>
			<a href="<?php echo __URL('APP_MAIN/member/my_son?id=2'); ?>">
				<p><img src="__TEMP__/<?php echo $style; ?>/public/images/my/people2.png"></p>
				<p>二级会员</p>
				<p style="color:#2ca1d1"><?php if($sonTwo): ?><?php echo $sonTwo; else: ?>0<?php endif; ?></p>
			</a>
			</li>
			
			<li>
			<a href="<?php echo __URL('APP_MAIN/member/my_son?id=3'); ?>">
				<p><img src="__TEMP__/<?php echo $style; ?>/public/images/my/people3.png"></p>
				<p>三级会员</p>
				<p style="color:#2ca1d1"><?php if($sonThree): ?><?php echo $sonThree; else: ?>0<?php endif; ?></p>
			</a>
			</li>
...
<script type="text/javascript">
	...
	function btnsave() {
        ...
        $.ajax({
            url: "<?php echo __URL('APP_MAIN/member/erji_xiugai'); ?>",
