<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:48:"template/wap\default\\Member\chuangye_zhuan.html";i:1509087340;s:30:"template/wap\default\base.html";i:1507430043;s:34:"template/wap\default\urlModel.html";i:1505377008;s:32:"template/wap\default\footer.html";i:1507607166;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="zdy_sj_srk">
  ...
  <form name="wytx_jbhz" id="wytx_jbhz">
      <div class="zdy_sj_srk1"><label for="balance">转出积分</label>
               <div class="div_input"><input type="text" value="" name="balance" id="balance" placeholder="余额：<?php echo $arr[point]; ?>"></div>
               <div class="blank" style="height:0px;"></div>
       </div>
...
function addAccount(type){
	...
	if (!flag) {
		...
		$.ajax({
			type : "post",
			url : "<?php echo __URL('APP_MAIN/member/chuangye_zhuan'); ?>",
			data : {
				"type" : 1,
				"num" : num,
