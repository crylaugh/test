<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:46:"template/adminblue\Goods\updateGoodsGroup.html";i:1503280183;s:28:"template/adminblue\base.html";i:1508840920;s:45:"template/adminblue\controlCommonVariable.html";i:1503719297;s:32:"template/adminblue\urlModel.html";i:1504865854;s:34:"template/adminblue\pageCommon.html";i:1505550036;s:34:"template/adminblue\openDialog.html";i:1509005619;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
	...
	<dl>
		...
		<dd>
			<div class="class-logo">
				<p>
					<img id="imgLogo" <?php if($data['group_pic']!=''): ?>src="<?php echo __IMG($data['picture']['pic_cover']); ?>" <?php endif; ?>>
				</p>
			</div>
			<div class="upload-btn" onclick="imgUpload();">
				<span><input type="hidden" value="<?php echo $data['group_pic']; ?>" id="group_pic" /></span>
				<p><i class="fa fa-cloud-upload"></i>图片上传</p>
			</div>
			<p class="hint">
