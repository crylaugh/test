<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:41:"template/wap\default\Pay\payCallback.html";i:1509333932;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<article>
	<?php if($status==1): ?>
		...
		<p><?php echo lang('order_number'); ?><?php echo $out_trade_no; ?></p>
	<?php else: ?>
		<div class="pay-block">
			<img src="__TEMP__/<?php echo $style; ?>/public/css/pay/pay_error.png"/>
		</div>
		<h3><?php echo lang('payment_failed'); ?></h3>
		<p style="color:#FF3C3C;"><?php echo lang('order_number'); ?><?php echo $out_trade_no; ?></p>
	<?php endif; ?>
