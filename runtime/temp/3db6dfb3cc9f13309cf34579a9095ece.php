...
<div class="goods-prompt">
	...
	<div class="goods-state a-line">
		<ul>
			...
			<li onclick="location.href='<?php echo __URL('ADMIN_MAIN/goods/goodslist'); ?>'"><h4 class="stock_early_warning">0</h4>库存预警</li>
		</ul>
	</div>
</div>
